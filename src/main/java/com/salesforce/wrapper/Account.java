...
public class Account {
    ...
    private static final String ADDRESS_INPUT_LOCATOR = "//span[text()='%s']//ancestor::div[@class='form-element__row']//textarea";
    private static final String DROPDOWN_LOCATOR = "//span[text()='%s']//ancestor::div[@class='slds-form-element__control']//a";
