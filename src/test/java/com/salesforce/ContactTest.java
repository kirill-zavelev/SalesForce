...
//                .waitForPageOpening()
//                .deleteContact(contactForm.getFirstName());
//        final String expectedContactDeletedMessage = "Contact " + "\"" + contactForm.getFirstName() + "\""
//                + " was deleted.";
//        Assertions.assertThat(contactsPage.getContactDeletedMessage())
//                .as("Message should contains of " + expectedContactDeletedMessage)
//                .contains(expectedContactDeletedMessage);
//        Assertions.assertThat(new ContactsPage(driver).getContactsNames())
//                .as("List of contacts names should not contain: " + contactForm.getFirstName())
//                .doesNotContain(contactForm.getFirstName());
//        if (driver != null) {
//            driver.quit();
//        }
//    }
